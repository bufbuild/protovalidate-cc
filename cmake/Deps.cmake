...
elseif(DEFINED protobuf_SOURCE_DIR)
    ...
    message(FATAL_ERROR "protovalidate-cc: Error determining protobuf import path: Protobuf_INCLUDE_DIRS is not set. Check that your Protobuf installation is correct and up-to-date enough.")
endif()
